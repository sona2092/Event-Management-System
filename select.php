                            ...
                            <div class="col-md-12">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['stud_id']))
                                    {
                                        ...
                                        $query = "SELECT * FROM service WHERE id='$stud_id' ";
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $row)
                                            {
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="">Venue Selection</label>
                                                    <input type="text" value="<?= $row['venue']; ?>" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="">Invitation Card</label>
                                                    <input type="text" value="<?= $row['card']; ?>" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="">Music and Sound</label>
                                                    <input type="text" value="<?= $row['sound']; ?>" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="">Food and Drinks</label>
                                                    <input type="text" value="<?= $row['food']; ?>" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="">Photography</label>
                                                    <input type="text" value="<?= $row['photo']; ?>" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="">Transportation</label>
                                                    <input type="text" value="<?= $row['trans']; ?>" class="form-control">
                                                </div>
                                                <?php
                                            }
                                        }
