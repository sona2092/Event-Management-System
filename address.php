                            ...
                            <div class="col-md-12">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['stud_id']))
                                    {
                                        ...
                                        $query = "SELECT * FROM address WHERE id='$stud_id' ";
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $row)
                                            {
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" value="<?= $row['nation']; ?>" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" value="<?= $row['district']; ?>" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="">Block Number</label>
                                                    <input type="text" value="<?= $row['block']; ?>" class="form-control">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="">Ward Number</label>
                                                    <input type="text" value="<?= $row['ward']; ?>" class="form-control">
                                                </div>
                                                <?php
                                            }
                                        }
